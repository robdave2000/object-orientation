...
{
  band: "Linken Park",
  food: "Steak and shrimp habachi",
  person: "Chris Evans",
  book: "Percy Jackson and the lightning theif",
...
//Code Here
let newPhone1 = new Phone ("Samsung", "S21", 256, "Black", 799);
let newPhone2 = new Phone ("Apple", "IPhone 12", 256, "White", 899);
let newPhone3 = new Phone ("Google", "Pixel 3", 128, "Black", 499);
...
//Code Here
let myFirstVehicle = new Vehicle (2, "red", 120000);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle (1, "green", 6000, "Yamaha", true);
/*
...
//Code Here
let newBoat = new Boat (8, "White", 16000, "Rias", "Mini Yacht", false);
/*
